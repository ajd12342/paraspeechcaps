...
class SSL_ECAPA_TDNN(nn.Module):
    def __init__(self, feat_dim=80, channels=512, emb_dim=192, global_context_att=False,
                 ...
                 update_extract=False, initial_model="", **kwargs):
        super().__init__()
        ...
        if feat_type == 'fbank':
            ...
            melkwargs = {
                'n_fft': 512, 'win_length': win_len, 'hop_length': hop_len,
            ...
            if (len(self.feature_extract.model.encoder.layers) == 24 and
                    hasattr(self.feature_extract.model.encoder.layers[23].self_attn, "fp32_attention")):
                self.feature_extract.model.encoder.layers[23].self_attn.fp32_attention = False
            if (len(self.feature_extract.model.encoder.layers) == 24 and
                    hasattr(self.feature_extract.model.encoder.layers[11].self_attn, "fp32_attention")):
